...
class NewIncome extends StatefulWidget {
  const NewIncome({Key? key, required this.onAddIncome}): super(
          key: key,
        );
...
class _NewIncomeState extends State<NewIncome> {
  ...
  Category1 _selectedCategory = Category1.Employment;
  ...
  void _submitIncomeData() {
    ...
    BlocProvider.of<IncomeBloc>(context).add(AddIncomeEvent(income)); // Dispatch event
